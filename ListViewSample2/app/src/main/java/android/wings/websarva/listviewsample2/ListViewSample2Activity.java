...
public class ListViewSample2Activity extends AppCompatActivity {
    ...
    private class ListItemClickListener implements AdapterView.OnItemClickListener {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            ...
            com.websarva.wings.android.listviewsample2.OrderConfirmDialogFragment dialogFragment = new com.websarva.wings.android.listviewsample2.OrderConfirmDialogFragment();
            //ダイアログ表示。
